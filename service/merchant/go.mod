module github.com/MamangRust/microservice-payment-gateway-grpc/service/merchant
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/merchant => ./
