...
func (q *Queries) FindAllTransactions(ctx context.Context, arg FindAllTransactionsParams) ([]*FindAllTransactionsRow, error) {
	rows, err := q.db.Query(ctx, findAllTransactions, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) FindAllTransactionsByApikey(ctx context.Context, arg FindAllTransactionsByApikeyParams) ([]*FindAllTransactionsByApikeyRow, error) {
	rows, err := q.db.Query(ctx, findAllTransactionsByApikey,
		arg.ApiKey,
		arg.Column2,
		arg.Limit,
		arg.Offset,
...
func (q *Queries) FindAllTransactionsByMerchant(ctx context.Context, arg FindAllTransactionsByMerchantParams) ([]*FindAllTransactionsByMerchantRow, error) {
	rows, err := q.db.Query(ctx, findAllTransactionsByMerchant,
		arg.MerchantID,
		arg.Column2,
		arg.Limit,
		arg.Offset,
...
func (q *Queries) GetActiveMerchants(ctx context.Context, arg GetActiveMerchantsParams) ([]*GetActiveMerchantsRow, error) {
	rows, err := q.db.Query(ctx, getActiveMerchants, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMerchantByApiKey(ctx context.Context, apiKey string) (*GetMerchantByApiKeyRow, error) {
	row := q.db.QueryRow(ctx, getMerchantByApiKey, apiKey)
...
type GetMerchantByNameRow struct {
	MerchantID int32            `json:"merchant_id"`
	MerchantNo pgtype.UUID      `json:"merchant_no"`
	Name       string           `json:"name"`
	ApiKey     string           `json:"api_key"`
...
// Business Logic:
//   - Excludes soft-deleted merchants (deleted_at IS NULL)
func (q *Queries) GetMerchantByName(ctx context.Context, name string) (*GetMerchantByNameRow, error) {
	row := q.db.QueryRow(ctx, getMerchantByName, name)
	var i GetMerchantByNameRow
	err := row.Scan(
		&i.MerchantID,
		&i.MerchantNo,
		&i.Name,
...
type GetMerchantsByUserIDRow struct {
	MerchantID int32            `json:"merchant_id"`
	MerchantNo pgtype.UUID      `json:"merchant_no"`
	Name       string           `json:"name"`
	ApiKey     string           `json:"api_key"`
...
// Business Logic:
//   - Excludes soft-deleted merchants (deleted_at IS NULL)
func (q *Queries) GetMerchantsByUserID(ctx context.Context, userID int32) ([]*GetMerchantsByUserIDRow, error) {
	rows, err := q.db.Query(ctx, getMerchantsByUserID, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []*GetMerchantsByUserIDRow
	for rows.Next() {
		var i GetMerchantsByUserIDRow
		if err := rows.Scan(
			&i.MerchantID,
			&i.MerchantNo,
			&i.Name,
...
func (q *Queries) GetMonthlyAmountByApikey(ctx context.Context, arg GetMonthlyAmountByApikeyParams) ([]*GetMonthlyAmountByApikeyRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyAmountByApikey, arg.Column1, arg.ApiKey)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyAmountByMerchants(ctx context.Context, arg GetMonthlyAmountByMerchantsParams) ([]*GetMonthlyAmountByMerchantsRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyAmountByMerchants, arg.Column1, arg.MerchantID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyAmountMerchant(ctx context.Context, dollar_1 time.Time) ([]*GetMonthlyAmountMerchantRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyAmountMerchant, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyPaymentMethodByApikey(ctx context.Context, arg GetMonthlyPaymentMethodByApikeyParams) ([]*GetMonthlyPaymentMethodByApikeyRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyPaymentMethodByApikey, arg.Column1, arg.ApiKey)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyPaymentMethodByMerchants(ctx context.Context, arg GetMonthlyPaymentMethodByMerchantsParams) ([]*GetMonthlyPaymentMethodByMerchantsRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyPaymentMethodByMerchants, arg.Column1, arg.MerchantID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyPaymentMethodsMerchant(ctx context.Context, dollar_1 time.Time) ([]*GetMonthlyPaymentMethodsMerchantRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyPaymentMethodsMerchant, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyTotalAmountByApikey(ctx context.Context, arg GetMonthlyTotalAmountByApikeyParams) ([]*GetMonthlyTotalAmountByApikeyRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTotalAmountByApikey, arg.Column1, arg.ApiKey)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyTotalAmountByMerchant(ctx context.Context, arg GetMonthlyTotalAmountByMerchantParams) ([]*GetMonthlyTotalAmountByMerchantRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTotalAmountByMerchant, arg.Column1, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyTotalAmountMerchant(ctx context.Context, dollar_1 time.Time) ([]*GetMonthlyTotalAmountMerchantRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTotalAmountMerchant, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTrashedMerchantByID(ctx context.Context, merchantID int32) (*Merchant, error) {
	row := q.db.QueryRow(ctx, getTrashedMerchantByID, merchantID)
	var i Merchant
	err := row.Scan(
		&i.MerchantID,
		&i.MerchantNo,
...
func (q *Queries) GetTrashedMerchants(ctx context.Context, arg GetTrashedMerchantsParams) ([]*GetTrashedMerchantsRow, error) {
	rows, err := q.db.Query(ctx, getTrashedMerchants, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyAmountByApikey(ctx context.Context, arg GetYearlyAmountByApikeyParams) ([]*GetYearlyAmountByApikeyRow, error) {
	rows, err := q.db.Query(ctx, getYearlyAmountByApikey, arg.ApiKey, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyAmountByMerchants(ctx context.Context, arg GetYearlyAmountByMerchantsParams) ([]*GetYearlyAmountByMerchantsRow, error) {
	rows, err := q.db.Query(ctx, getYearlyAmountByMerchants, arg.MerchantID, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyAmountMerchant(ctx context.Context, dollar_1 interface{}) ([]*GetYearlyAmountMerchantRow, error) {
	rows, err := q.db.Query(ctx, getYearlyAmountMerchant, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyPaymentMethodByApikey(ctx context.Context, arg GetYearlyPaymentMethodByApikeyParams) ([]*GetYearlyPaymentMethodByApikeyRow, error) {
	rows, err := q.db.Query(ctx, getYearlyPaymentMethodByApikey, arg.ApiKey, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyPaymentMethodByMerchants(ctx context.Context, arg GetYearlyPaymentMethodByMerchantsParams) ([]*GetYearlyPaymentMethodByMerchantsRow, error) {
	rows, err := q.db.Query(ctx, getYearlyPaymentMethodByMerchants, arg.MerchantID, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyPaymentMethodMerchant(ctx context.Context, dollar_1 interface{}) ([]*GetYearlyPaymentMethodMerchantRow, error) {
	rows, err := q.db.Query(ctx, getYearlyPaymentMethodMerchant, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTotalAmountByApikey(ctx context.Context, arg GetYearlyTotalAmountByApikeyParams) ([]*GetYearlyTotalAmountByApikeyRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTotalAmountByApikey, arg.Column1, arg.ApiKey)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTotalAmountByMerchant(ctx context.Context, arg GetYearlyTotalAmountByMerchantParams) ([]*GetYearlyTotalAmountByMerchantRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTotalAmountByMerchant, arg.Column1, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTotalAmountMerchant(ctx context.Context, dollar_1 int32) ([]*GetYearlyTotalAmountMerchantRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTotalAmountMerchant, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
