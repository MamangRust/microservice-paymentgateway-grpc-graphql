...
func (q *Queries) CreateWithdraw(ctx context.Context, arg CreateWithdrawParams) (*CreateWithdrawRow, error) {
...
func (q *Queries) DeleteAllPermanentWithdraws(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentWithdraws)
	return err
}
...
func (q *Queries) DeleteWithdrawPermanently(ctx context.Context, withdrawID int32) error {
	_, err := q.db.Exec(ctx, deleteWithdrawPermanently, withdrawID)
	return err
}
...
func (q *Queries) FindAllWithdrawsByCardNumber(ctx context.Context, cardNumber string) ([]*FindAllWithdrawsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, findAllWithdrawsByCardNumber, cardNumber)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetActiveWithdraws(ctx context.Context, arg GetActiveWithdrawsParams) ([]*GetActiveWithdrawsRow, error) {
	rows, err := q.db.Query(ctx, getActiveWithdraws, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthWithdrawStatusFailed(ctx context.Context, arg GetMonthWithdrawStatusFailedParams) ([]*GetMonthWithdrawStatusFailedRow, error) {
	rows, err := q.db.Query(ctx, getMonthWithdrawStatusFailed,
		arg.Column1,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthWithdrawStatusFailedCardNumber(ctx context.Context, arg GetMonthWithdrawStatusFailedCardNumberParams) ([]*GetMonthWithdrawStatusFailedCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthWithdrawStatusFailedCardNumber,
		arg.CardNumber,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthWithdrawStatusSuccess(ctx context.Context, arg GetMonthWithdrawStatusSuccessParams) ([]*GetMonthWithdrawStatusSuccessRow, error) {
	rows, err := q.db.Query(ctx, getMonthWithdrawStatusSuccess,
		arg.Column1,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthWithdrawStatusSuccessCardNumber(ctx context.Context, arg GetMonthWithdrawStatusSuccessCardNumberParams) ([]*GetMonthWithdrawStatusSuccessCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthWithdrawStatusSuccessCardNumber,
		arg.CardNumber,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthlyWithdraws(ctx context.Context, dollar_1 time.Time) ([]*GetMonthlyWithdrawsRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyWithdraws, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyWithdrawsByCardNumber(ctx context.Context, arg GetMonthlyWithdrawsByCardNumberParams) ([]*GetMonthlyWithdrawsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyWithdrawsByCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const getTodayWithdrawSumByCardNumber = `-- name: GetTodayWithdrawSumByCardNumber :one
...
func (q *Queries) GetTodayWithdrawSumByCardNumber(ctx context.Context, cardNumber string) (int64, error) {
	row := q.db.QueryRow(ctx, getTodayWithdrawSumByCardNumber, cardNumber)
...
func (q *Queries) GetTrashedWithdrawByID(ctx context.Context, withdrawID int32) (*Withdraw, error) {
	row := q.db.QueryRow(ctx, getTrashedWithdrawByID, withdrawID)
	var i Withdraw
	err := row.Scan(
		&i.WithdrawID,
		&i.WithdrawNo,
...
func (q *Queries) GetTrashedWithdraws(ctx context.Context, arg GetTrashedWithdrawsParams) ([]*GetTrashedWithdrawsRow, error) {
	rows, err := q.db.Query(ctx, getTrashedWithdraws, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type GetWithdrawByIDRow struct {
	WithdrawID     int32            `json:"withdraw_id"`
	WithdrawNo     pgtype.UUID      `json:"withdraw_no"`
	CardNumber     string           `json:"card_number"`
	WithdrawAmount int64            `json:"withdraw_amount"`
...
func (q *Queries) GetWithdrawByID(ctx context.Context, withdrawID int32) (*GetWithdrawByIDRow, error) {
	row := q.db.QueryRow(ctx, getWithdrawByID, withdrawID)
	var i GetWithdrawByIDRow
	err := row.Scan(
		&i.WithdrawID,
		&i.WithdrawNo,
		&i.CardNumber,
...
func (q *Queries) GetWithdraws(ctx context.Context, arg GetWithdrawsParams) ([]*GetWithdrawsRow, error) {
	rows, err := q.db.Query(ctx, getWithdraws, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetWithdrawsByCardNumber(ctx context.Context, arg GetWithdrawsByCardNumberParams) ([]*GetWithdrawsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getWithdrawsByCardNumber,
		arg.CardNumber,
		arg.Column2,
		arg.Limit,
		arg.Offset,
...
func (q *Queries) GetYearlyWithdrawStatusFailed(ctx context.Context, dollar_1 int32) ([]*GetYearlyWithdrawStatusFailedRow, error) {
	rows, err := q.db.Query(ctx, getYearlyWithdrawStatusFailed, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyWithdrawStatusFailedCardNumber(ctx context.Context, arg GetYearlyWithdrawStatusFailedCardNumberParams) ([]*GetYearlyWithdrawStatusFailedCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyWithdrawStatusFailedCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyWithdrawStatusSuccess(ctx context.Context, dollar_1 int32) ([]*GetYearlyWithdrawStatusSuccessRow, error) {
	rows, err := q.db.Query(ctx, getYearlyWithdrawStatusSuccess, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyWithdrawStatusSuccessCardNumber(ctx context.Context, arg GetYearlyWithdrawStatusSuccessCardNumberParams) ([]*GetYearlyWithdrawStatusSuccessCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyWithdrawStatusSuccessCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyWithdraws(ctx context.Context, dollar_1 interface{}) ([]*GetYearlyWithdrawsRow, error) {
	rows, err := q.db.Query(ctx, getYearlyWithdraws, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyWithdrawsByCardNumber(ctx context.Context, arg GetYearlyWithdrawsByCardNumberParams) ([]*GetYearlyWithdrawsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyWithdrawsByCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllWithdraws(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllWithdraws)
	return err
}
...
func (q *Queries) RestoreWithdraw(ctx context.Context, withdrawID int32) (*Withdraw, error) {
	row := q.db.QueryRow(ctx, restoreWithdraw, withdrawID)
	var i Withdraw
	err := row.Scan(
		&i.WithdrawID,
		&i.WithdrawNo,
...
func (q *Queries) TrashWithdraw(ctx context.Context, withdrawID int32) (*Withdraw, error) {
	row := q.db.QueryRow(ctx, trashWithdraw, withdrawID)
	var i Withdraw
	err := row.Scan(
		&i.WithdrawID,
		&i.WithdrawNo,
...
func (q *Queries) UpdateWithdraw(ctx context.Context, arg UpdateWithdrawParams) (*UpdateWithdrawRow, error) {
	row := q.db.QueryRow(ctx, updateWithdraw,
		arg.WithdrawID,
		arg.CardNumber,
		arg.WithdrawAmount,
		arg.WithdrawTime,
	)
	var i UpdateWithdrawRow
	err := row.Scan(
		&i.WithdrawID,
		&i.WithdrawNo,
		&i.CardNumber,
...
type UpdateWithdrawStatusRow struct {
	WithdrawID     int32            `json:"withdraw_id"`
	WithdrawNo     pgtype.UUID      `json:"withdraw_no"`
	CardNumber     string           `json:"card_number"`
	WithdrawAmount int64            `json:"withdraw_amount"`
...
func (q *Queries) UpdateWithdrawStatus(ctx context.Context, arg UpdateWithdrawStatusParams) (*UpdateWithdrawStatusRow, error) {
	row := q.db.QueryRow(ctx, updateWithdrawStatus, arg.WithdrawID, arg.Status)
	var i UpdateWithdrawStatusRow
	err := row.Scan(
		&i.WithdrawID,
		&i.WithdrawNo,
		&i.CardNumber,
