module github.com/MamangRust/microservice-payment-gateway-grpc/service/withdraw
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/withdraw => ./
