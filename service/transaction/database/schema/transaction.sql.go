...
SELECT transaction_id, transaction_no, card_number, amount, payment_method, merchant_id, transaction_time, status, created_at, updated_at, deleted_at, operation_id, failure_reason, COUNT(*) OVER () AS total_count
FROM transactions
WHERE
    deleted_at IS NULL
    AND card_number = $1
...
SELECT transaction_id, transaction_no, card_number, amount, payment_method, merchant_id, transaction_time, status, created_at, updated_at, deleted_at, operation_id, failure_reason
FROM transactions
WHERE
    transaction_id = $1
    AND deleted_at IS NOT NULL
...
WHERE
    transaction_id = $1
    AND deleted_at IS NOT NULL
RETURNING transaction_id, transaction_no, card_number, amount, payment_method, merchant_id, transaction_time, status, created_at, updated_at, deleted_at, operation_id, failure_reason
`
