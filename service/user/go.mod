module github.com/MamangRust/microservice-payment-gateway-grpc/service/user
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/user => ./
