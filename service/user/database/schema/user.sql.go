...
func (q *Queries) GetActiveUsersWithPagination(ctx context.Context, arg GetActiveUsersWithPaginationParams) ([]*GetActiveUsersWithPaginationRow, error) {
	rows, err := q.db.Query(ctx, getActiveUsersWithPagination, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTrashedUserByID(ctx context.Context, userID int32) (*User, error) {
	row := q.db.QueryRow(ctx, getTrashedUserByID, userID)
	var i User
	err := row.Scan(
		&i.UserID,
		&i.Firstname,
...
func (q *Queries) GetTrashedUsersWithPagination(ctx context.Context, arg GetTrashedUsersWithPaginationParams) ([]*GetTrashedUsersWithPaginationRow, error) {
	rows, err := q.db.Query(ctx, getTrashedUsersWithPagination, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type GetUserByEmailAndVerifiedRow struct {
	UserID    int32            `json:"user_id"`
	Firstname string           `json:"firstname"`
	Lastname  string           `json:"lastname"`
	Email     string           `json:"email"`
...
func (q *Queries) GetUserByEmailAndVerified(ctx context.Context, email string) (*GetUserByEmailAndVerifiedRow, error) {
	row := q.db.QueryRow(ctx, getUserByEmailAndVerified, email)
	var i GetUserByEmailAndVerifiedRow
	err := row.Scan(
		&i.UserID,
		&i.Firstname,
		&i.Lastname,
...
func (q *Queries) GetUsersWithPagination(ctx context.Context, arg GetUsersWithPaginationParams) ([]*GetUsersWithPaginationRow, error) {
	rows, err := q.db.Query(ctx, getUsersWithPagination, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) SearchUsersByEmail(ctx context.Context, dollar_1 *string) ([]*User, error) {
