module github.com/MamangRust/microservice-payment-gateway-grpc/service/card
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/card => ./
