module github.com/MamangRust/microservice-payment-gateway-grpc/service/saldo
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/saldo => ./
