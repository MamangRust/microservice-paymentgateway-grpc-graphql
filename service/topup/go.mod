module github.com/MamangRust/microservice-payment-gateway-grpc/service/topup
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/topup => ./
