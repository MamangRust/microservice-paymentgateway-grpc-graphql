...
func (q *Queries) CreateTopup(ctx context.Context, arg CreateTopupParams) (*CreateTopupRow, error) {
	row := q.db.QueryRow(ctx, createTopup,
		arg.CardNumber,
		arg.TopupAmount,
		arg.TopupMethod,
		arg.TopupTime,
	)
	var i CreateTopupRow
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
		&i.CardNumber,
...
func (q *Queries) DeleteAllPermanentTopups(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentTopups)
	return err
}
...
func (q *Queries) DeleteTopupPermanently(ctx context.Context, topupID int32) error {
	_, err := q.db.Exec(ctx, deleteTopupPermanently, topupID)
	return err
}
...
func (q *Queries) GetActiveTopups(ctx context.Context, arg GetActiveTopupsParams) ([]*GetActiveTopupsRow, error) {
	rows, err := q.db.Query(ctx, getActiveTopups, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthTopupStatusFailed(ctx context.Context, arg GetMonthTopupStatusFailedParams) ([]*GetMonthTopupStatusFailedRow, error) {
	rows, err := q.db.Query(ctx, getMonthTopupStatusFailed,
		arg.Column1,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthTopupStatusFailedCardNumber(ctx context.Context, arg GetMonthTopupStatusFailedCardNumberParams) ([]*GetMonthTopupStatusFailedCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthTopupStatusFailedCardNumber,
		arg.CardNumber,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthTopupStatusSuccess(ctx context.Context, arg GetMonthTopupStatusSuccessParams) ([]*GetMonthTopupStatusSuccessRow, error) {
	rows, err := q.db.Query(ctx, getMonthTopupStatusSuccess,
		arg.Column1,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthTopupStatusSuccessCardNumber(ctx context.Context, arg GetMonthTopupStatusSuccessCardNumberParams) ([]*GetMonthTopupStatusSuccessCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthTopupStatusSuccessCardNumber,
		arg.CardNumber,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthlyTopupAmounts(ctx context.Context, dollar_1 time.Time) ([]*GetMonthlyTopupAmountsRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTopupAmounts, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyTopupAmountsByCardNumber(ctx context.Context, arg GetMonthlyTopupAmountsByCardNumberParams) ([]*GetMonthlyTopupAmountsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTopupAmountsByCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyTopupMethods(ctx context.Context, dollar_1 time.Time) ([]*GetMonthlyTopupMethodsRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTopupMethods, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyTopupMethodsByCardNumber(ctx context.Context, arg GetMonthlyTopupMethodsByCardNumberParams) ([]*GetMonthlyTopupMethodsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTopupMethodsByCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTopupByID(ctx context.Context, topupID int32) (*GetTopupByIDRow, error) {
	row := q.db.QueryRow(ctx, getTopupByID, topupID)
	var i GetTopupByIDRow
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
		&i.CardNumber,
...
func (q *Queries) GetTopups(ctx context.Context, arg GetTopupsParams) ([]*GetTopupsRow, error) {
	rows, err := q.db.Query(ctx, getTopups, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTopupsByCardNumber(ctx context.Context, arg GetTopupsByCardNumberParams) ([]*GetTopupsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getTopupsByCardNumber,
		arg.CardNumber,
		arg.Column2,
		arg.Limit,
		arg.Offset,
...
func (q *Queries) GetTrashedTopupByID(ctx context.Context, topupID int32) (*Topup, error) {
	row := q.db.QueryRow(ctx, getTrashedTopupByID, topupID)
	var i Topup
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
...
func (q *Queries) GetTrashedTopups(ctx context.Context, arg GetTrashedTopupsParams) ([]*GetTrashedTopupsRow, error) {
	rows, err := q.db.Query(ctx, getTrashedTopups, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTopupAmounts(ctx context.Context, dollar_1 interface{}) ([]*GetYearlyTopupAmountsRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTopupAmounts, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTopupAmountsByCardNumber(ctx context.Context, arg GetYearlyTopupAmountsByCardNumberParams) ([]*GetYearlyTopupAmountsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTopupAmountsByCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTopupMethods(ctx context.Context, dollar_1 interface{}) ([]*GetYearlyTopupMethodsRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTopupMethods, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTopupMethodsByCardNumber(ctx context.Context, arg GetYearlyTopupMethodsByCardNumberParams) ([]*GetYearlyTopupMethodsByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTopupMethodsByCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTopupStatusFailed(ctx context.Context, dollar_1 int32) ([]*GetYearlyTopupStatusFailedRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTopupStatusFailed, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTopupStatusFailedCardNumber(ctx context.Context, arg GetYearlyTopupStatusFailedCardNumberParams) ([]*GetYearlyTopupStatusFailedCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTopupStatusFailedCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTopupStatusSuccess(ctx context.Context, dollar_1 int32) ([]*GetYearlyTopupStatusSuccessRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTopupStatusSuccess, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTopupStatusSuccessCardNumber(ctx context.Context, arg GetYearlyTopupStatusSuccessCardNumberParams) ([]*GetYearlyTopupStatusSuccessCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTopupStatusSuccessCardNumber, arg.CardNumber, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllTopups(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllTopups)
	return err
}
...
func (q *Queries) RestoreTopup(ctx context.Context, topupID int32) (*Topup, error) {
	row := q.db.QueryRow(ctx, restoreTopup, topupID)
	var i Topup
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
...
func (q *Queries) TrashTopup(ctx context.Context, topupID int32) (*Topup, error) {
	row := q.db.QueryRow(ctx, trashTopup, topupID)
	var i Topup
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
...
func (q *Queries) UpdateTopup(ctx context.Context, arg UpdateTopupParams) (*UpdateTopupRow, error) {
	row := q.db.QueryRow(ctx, updateTopup,
		arg.TopupID,
		arg.CardNumber,
		arg.TopupAmount,
		arg.TopupMethod,
...
type UpdateTopupAmountRow struct {
	TopupID     int32            `json:"topup_id"`
	TopupNo     pgtype.UUID      `json:"topup_no"`
	CardNumber  string           `json:"card_number"`
	TopupAmount int64            `json:"topup_amount"`
...
func (q *Queries) UpdateTopupAmount(ctx context.Context, arg UpdateTopupAmountParams) (*UpdateTopupAmountRow, error) {
	row := q.db.QueryRow(ctx, updateTopupAmount, arg.TopupID, arg.TopupAmount)
	var i UpdateTopupAmountRow
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
		&i.CardNumber,
...
type UpdateTopupStatusRow struct {
	TopupID     int32            `json:"topup_id"`
	TopupNo     pgtype.UUID      `json:"topup_no"`
	CardNumber  string           `json:"card_number"`
	TopupAmount int64            `json:"topup_amount"`
...
func (q *Queries) UpdateTopupStatus(ctx context.Context, arg UpdateTopupStatusParams) (*UpdateTopupStatusRow, error) {
	row := q.db.QueryRow(ctx, updateTopupStatus, arg.TopupID, arg.Status)
	var i UpdateTopupStatusRow
	err := row.Scan(
		&i.TopupID,
		&i.TopupNo,
		&i.CardNumber,
