module github.com/MamangRust/microservice-payment-gateway-grpc/service/transfer
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/transfer => ./
