...
func (q *Queries) DeleteAllPermanentTransfers(ctx context.Context) error {
	_, err := q.db.Exec(ctx, deleteAllPermanentTransfers)
	return err
}
...
func (q *Queries) DeleteTransferPermanently(ctx context.Context, transferID int32) error {
	_, err := q.db.Exec(ctx, deleteTransferPermanently, transferID)
	return err
}
...
func (q *Queries) FindAllTransfersByCardNumberAsReceiver(ctx context.Context, transferTo string) ([]*FindAllTransfersByCardNumberAsReceiverRow, error) {
	rows, err := q.db.Query(ctx, findAllTransfersByCardNumberAsReceiver, transferTo)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) FindAllTransfersByCardNumberAsSender(ctx context.Context, transferFrom string) ([]*FindAllTransfersByCardNumberAsSenderRow, error) {
	rows, err := q.db.Query(ctx, findAllTransfersByCardNumberAsSender, transferFrom)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetActiveTransfers(ctx context.Context, arg GetActiveTransfersParams) ([]*GetActiveTransfersRow, error) {
	rows, err := q.db.Query(ctx, getActiveTransfers, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthTransferStatusFailed(ctx context.Context, arg GetMonthTransferStatusFailedParams) ([]*GetMonthTransferStatusFailedRow, error) {
	rows, err := q.db.Query(ctx, getMonthTransferStatusFailed,
		arg.Column1,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthTransferStatusFailedCardNumber(ctx context.Context, arg GetMonthTransferStatusFailedCardNumberParams) ([]*GetMonthTransferStatusFailedCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthTransferStatusFailedCardNumber,
		arg.TransferFrom,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthTransferStatusSuccess(ctx context.Context, arg GetMonthTransferStatusSuccessParams) ([]*GetMonthTransferStatusSuccessRow, error) {
	rows, err := q.db.Query(ctx, getMonthTransferStatusSuccess,
		arg.Column1,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthTransferStatusSuccessCardNumber(ctx context.Context, arg GetMonthTransferStatusSuccessCardNumberParams) ([]*GetMonthTransferStatusSuccessCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthTransferStatusSuccessCardNumber,
		arg.TransferFrom,
		arg.Column2,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) GetMonthlyTransferAmounts(ctx context.Context, dollar_1 time.Time) ([]*GetMonthlyTransferAmountsRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTransferAmounts, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyTransferAmountsByReceiverCardNumber(ctx context.Context, arg GetMonthlyTransferAmountsByReceiverCardNumberParams) ([]*GetMonthlyTransferAmountsByReceiverCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTransferAmountsByReceiverCardNumber, arg.TransferTo, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetMonthlyTransferAmountsBySenderCardNumber(ctx context.Context, arg GetMonthlyTransferAmountsBySenderCardNumberParams) ([]*GetMonthlyTransferAmountsBySenderCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getMonthlyTransferAmountsBySenderCardNumber, arg.TransferFrom, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTransferByID(ctx context.Context, transferID int32) (*GetTransferByIDRow, error) {
	row := q.db.QueryRow(ctx, getTransferByID, transferID)
...
func (q *Queries) GetTransfers(ctx context.Context, arg GetTransfersParams) ([]*GetTransfersRow, error) {
	rows, err := q.db.Query(ctx, getTransfers, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type GetTransfersByCardNumberRow struct {
	TransferID     int32            `json:"transfer_id"`
	TransferNo     pgtype.UUID      `json:"transfer_no"`
	TransferFrom   string           `json:"transfer_from"`
	TransferTo     string           `json:"transfer_to"`
...
func (q *Queries) GetTransfersByCardNumber(ctx context.Context, transferFrom string) ([]*GetTransfersByCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getTransfersByCardNumber, transferFrom)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []*GetTransfersByCardNumberRow
	for rows.Next() {
		var i GetTransfersByCardNumberRow
		if err := rows.Scan(
			&i.TransferID,
			&i.TransferNo,
			&i.TransferFrom,
...
type GetTransfersByDestinationCardRow struct {
	TransferID     int32            `json:"transfer_id"`
	TransferNo     pgtype.UUID      `json:"transfer_no"`
	TransferFrom   string           `json:"transfer_from"`
	TransferTo     string           `json:"transfer_to"`
...
//   - Excludes soft-deleted records (deleted_at IS NULL)
//   - Sorted by most recent transfer first (DESC)
func (q *Queries) GetTransfersByDestinationCard(ctx context.Context, transferTo string) ([]*GetTransfersByDestinationCardRow, error) {
	rows, err := q.db.Query(ctx, getTransfersByDestinationCard, transferTo)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []*GetTransfersByDestinationCardRow
	for rows.Next() {
		var i GetTransfersByDestinationCardRow
		if err := rows.Scan(
			&i.TransferID,
			&i.TransferNo,
			&i.TransferFrom,
...
type GetTransfersBySourceCardRow struct {
	TransferID     int32            `json:"transfer_id"`
	TransferNo     pgtype.UUID      `json:"transfer_no"`
	TransferFrom   string           `json:"transfer_from"`
	TransferTo     string           `json:"transfer_to"`
...
//   - Excludes soft-deleted records (deleted_at IS NULL)
//   - Sorted by most recent transfer first (DESC)
func (q *Queries) GetTransfersBySourceCard(ctx context.Context, transferFrom string) ([]*GetTransfersBySourceCardRow, error) {
	rows, err := q.db.Query(ctx, getTransfersBySourceCard, transferFrom)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []*GetTransfersBySourceCardRow
	for rows.Next() {
		var i GetTransfersBySourceCardRow
		if err := rows.Scan(
			&i.TransferID,
			&i.TransferNo,
			&i.TransferFrom,
...
SELECT transfer_id, transfer_no, transfer_from, transfer_to, transfer_amount, transfer_time, status, created_at, updated_at, deleted_at, operation_id, failure_reason
FROM transfers
WHERE
    transfer_id = $1
    AND deleted_at IS NOT NULL
...
func (q *Queries) GetTrashedTransferByID(ctx context.Context, transferID int32) (*Transfer, error) {
	row := q.db.QueryRow(ctx, getTrashedTransferByID, transferID)
	var i Transfer
	err := row.Scan(
		&i.TransferID,
		&i.TransferNo,
...
func (q *Queries) GetTrashedTransfers(ctx context.Context, arg GetTrashedTransfersParams) ([]*GetTrashedTransfersRow, error) {
	rows, err := q.db.Query(ctx, getTrashedTransfers, arg.Column1, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTransferAmounts(ctx context.Context, dollar_1 interface{}) ([]*GetYearlyTransferAmountsRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTransferAmounts, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTransferAmountsByReceiverCardNumber(ctx context.Context, arg GetYearlyTransferAmountsByReceiverCardNumberParams) ([]*GetYearlyTransferAmountsByReceiverCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTransferAmountsByReceiverCardNumber, arg.TransferTo, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTransferAmountsBySenderCardNumber(ctx context.Context, arg GetYearlyTransferAmountsBySenderCardNumberParams) ([]*GetYearlyTransferAmountsBySenderCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTransferAmountsBySenderCardNumber, arg.TransferFrom, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTransferStatusFailed(ctx context.Context, dollar_1 int32) ([]*GetYearlyTransferStatusFailedRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTransferStatusFailed, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTransferStatusFailedCardNumber(ctx context.Context, arg GetYearlyTransferStatusFailedCardNumberParams) ([]*GetYearlyTransferStatusFailedCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTransferStatusFailedCardNumber, arg.TransferFrom, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTransferStatusSuccess(ctx context.Context, dollar_1 int32) ([]*GetYearlyTransferStatusSuccessRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTransferStatusSuccess, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetYearlyTransferStatusSuccessCardNumber(ctx context.Context, arg GetYearlyTransferStatusSuccessCardNumberParams) ([]*GetYearlyTransferStatusSuccessCardNumberRow, error) {
	rows, err := q.db.Query(ctx, getYearlyTransferStatusSuccessCardNumber, arg.TransferFrom, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RestoreAllTransfers(ctx context.Context) error {
	_, err := q.db.Exec(ctx, restoreAllTransfers)
	return err
}
...
WHERE
    transfer_id = $1
    AND deleted_at IS NOT NULL
RETURNING transfer_id, transfer_no, transfer_from, transfer_to, transfer_amount, transfer_time, status, created_at, updated_at, deleted_at, operation_id, failure_reason
`
...
func (q *Queries) RestoreTransfer(ctx context.Context, transferID int32) (*Transfer, error) {
	row := q.db.QueryRow(ctx, restoreTransfer, transferID)
	var i Transfer
	err := row.Scan(
		&i.TransferID,
		&i.TransferNo,
...
func (q *Queries) TrashTransfer(ctx context.Context, transferID int32) (*Transfer, error) {
	row := q.db.QueryRow(ctx, trashTransfer, transferID)
	var i Transfer
	err := row.Scan(
		&i.TransferID,
		&i.TransferNo,
...
func (q *Queries) UpdateTransfer(ctx context.Context, arg UpdateTransferParams) (*UpdateTransferRow, error) {
...
type UpdateTransferAmountRow struct {
	TransferID     int32            `json:"transfer_id"`
	TransferNo     pgtype.UUID      `json:"transfer_no"`
	TransferFrom   string           `json:"transfer_from"`
	TransferTo     string           `json:"transfer_to"`
...
func (q *Queries) UpdateTransferAmount(ctx context.Context, arg UpdateTransferAmountParams) (*UpdateTransferAmountRow, error) {
	row := q.db.QueryRow(ctx, updateTransferAmount, arg.TransferID, arg.TransferAmount)
	var i UpdateTransferAmountRow
	err := row.Scan(
		&i.TransferID,
		&i.TransferNo,
		&i.TransferFrom,
...
type UpdateTransferStatusRow struct {
	TransferID     int32            `json:"transfer_id"`
	TransferNo     pgtype.UUID      `json:"transfer_no"`
	TransferFrom   string           `json:"transfer_from"`
	TransferTo     string           `json:"transfer_to"`
...
func (q *Queries) UpdateTransferStatus(ctx context.Context, arg UpdateTransferStatusParams) (*UpdateTransferStatusRow, error) {
	row := q.db.QueryRow(ctx, updateTransferStatus, arg.TransferID, arg.Status)
