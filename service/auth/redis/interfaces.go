...
type IdentityCache interface {
	...
	SetCachedUserInfo(ctx context.Context, user *userdb.GetUserByIDRow, expiration time.Duration)

	GetCachedUserInfo(ctx context.Context, userId string) (*userdb.GetUserByIDRow, bool)
