module github.com/MamangRust/microservice-payment-gateway-grpc/service/auth
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/auth => ./
