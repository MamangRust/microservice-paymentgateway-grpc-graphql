module github.com/MamangRust/microservice-payment-gateway-grpc/service/role
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/role => ./
