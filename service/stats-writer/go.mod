module github.com/MamangRust/microservice-payment-gateway-grpc/service/stats-writer
...
replace github.com/MamangRust/microservice-payment-gateway-grpc/service/stats-writer => ./
