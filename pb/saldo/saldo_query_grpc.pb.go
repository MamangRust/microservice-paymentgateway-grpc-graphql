...
const (
	...
	SaldoQueryService_ListReconciliationQueue_FullMethodName = "/pb.saldo.SaldoQueryService/ListReconciliationQueue"
	SaldoQueryService_ListLedgerEntries_FullMethodName       = "/pb.saldo.SaldoQueryService/ListLedgerEntries"
)
...
type SaldoQueryServiceClient interface {
	...
	ListReconciliationQueue(ctx context.Context, in *ListReconciliationRequest, opts ...grpc.CallOption) (*ApiResponseReconciliation, error)
	ListLedgerEntries(ctx context.Context, in *ListLedgerEntriesRequest, opts ...grpc.CallOption) (*ApiResponseLedger, error)
}
...
func (c *saldoQueryServiceClient) ListReconciliationQueue(ctx context.Context, in *ListReconciliationRequest, opts ...grpc.CallOption) (*ApiResponseReconciliation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseReconciliation)
	err := c.cc.Invoke(ctx, SaldoQueryService_ListReconciliationQueue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *saldoQueryServiceClient) ListLedgerEntries(ctx context.Context, in *ListLedgerEntriesRequest, opts ...grpc.CallOption) (*ApiResponseLedger, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseLedger)
	err := c.cc.Invoke(ctx, SaldoQueryService_ListLedgerEntries_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SaldoQueryServiceServer interface {
	...
	ListReconciliationQueue(context.Context, *ListReconciliationRequest) (*ApiResponseReconciliation, error)
	ListLedgerEntries(context.Context, *ListLedgerEntriesRequest) (*ApiResponseLedger, error)
...
func (UnimplementedSaldoQueryServiceServer) FindAllSaldo(context.Context, *FindAllSaldoRequest) (*ApiResponsePaginationSaldo, error) {
	return nil, status.Error(codes.Unimplemented, "method FindAllSaldo not implemented")
}
func (UnimplementedSaldoQueryServiceServer) FindByIdSaldo(context.Context, *FindByIdSaldoRequest) (*ApiResponseSaldo, error) {
	return nil, status.Error(codes.Unimplemented, "method FindByIdSaldo not implemented")
}
func (UnimplementedSaldoQueryServiceServer) FindByCardNumber(context.Context, *card.FindByCardNumberRequest) (*ApiResponseSaldo, error) {
	return nil, status.Error(codes.Unimplemented, "method FindByCardNumber not implemented")
}
...
func (UnimplementedSaldoQueryServiceServer) ListReconciliationQueue(context.Context, *ListReconciliationRequest) (*ApiResponseReconciliation, error) {
	return nil, status.Error(codes.Unimplemented, "method ListReconciliationQueue not implemented")
}
func (UnimplementedSaldoQueryServiceServer) ListLedgerEntries(context.Context, *ListLedgerEntriesRequest) (*ApiResponseLedger, error) {
...
func RegisterSaldoQueryServiceServer(s grpc.ServiceRegistrar, srv SaldoQueryServiceServer) {
	// If the following call panics, it indicates UnimplementedSaldoQueryServiceServer was
...
func _SaldoQueryService_ListReconciliationQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListReconciliationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SaldoQueryServiceServer).ListReconciliationQueue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SaldoQueryService_ListReconciliationQueue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SaldoQueryServiceServer).ListReconciliationQueue(ctx, req.(*ListReconciliationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SaldoQueryService_ListLedgerEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListLedgerEntriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SaldoQueryServiceServer).ListLedgerEntries(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SaldoQueryService_ListLedgerEntries_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SaldoQueryServiceServer).ListLedgerEntries(ctx, req.(*ListLedgerEntriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SaldoQueryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListReconciliationQueue",
			Handler:    _SaldoQueryService_ListReconciliationQueue_Handler,
		},
		{
			MethodName: "ListLedgerEntries",
			Handler:    _SaldoQueryService_ListLedgerEntries_Handler,
		},
	},
