...
const file_transfer_transfer_command_proto_rawDesc = "" +
	"\n" +
	"\x1ftransfer/transfer_command.proto\x12\vpb.transfer\x1a\x1bgoogle/protobuf/empty.proto\x1a\x17transfer/transfer.proto\"\xaf\x01\n" +
	"\x15CreateTransferRequest\x12#\n" +
	"\rtransfer_from\x18\x01 \x01(\tR\ftransferFrom\x12\x1f\n" +
	"\vtransfer_to\x18\x02 \x01(\tR\n" +
	"transferTo\x12'\n" +
	"\x0ftransfer_amount\x18\x03 \x01(\x03R\x0etransferAmount\x12'\n" +
	"\x0fidempotency_key\x18\x04 \x01(\tR\x0eidempotencyKey\"\xa7\x01\n" +
	...
	"transferTo\x12'\n" +
	"\x0ftransfer_amount\x18\x04 \x01(\x03R\x0etransferAmount\"M\n" +
	...
	"\x1aDeleteAllTransferPermanent\x12\x16.google.protobuf.Empty\x1a#.pb.transfer.ApiResponseTransferAll\"\x00BEZCgithub.com/MamangRust/microservice-payment-gateway-grpc/pb/transferb\x06proto3"
