...
type UserQueryServiceClient interface {
	...
	FindByVerificationCode(ctx context.Context, in *FindByVerificationCodeUserRequest, opts ...grpc.CallOption) (*ApiResponseUser, error)
...
func (c *userQueryServiceClient) FindByVerificationCode(ctx context.Context, in *FindByVerificationCodeUserRequest, opts ...grpc.CallOption) (*ApiResponseUser, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseUser)
...
type UserQueryServiceServer interface {
	...
	FindByVerificationCode(context.Context, *FindByVerificationCodeUserRequest) (*ApiResponseUser, error)
...
func (UnimplementedUserQueryServiceServer) FindByVerificationCode(context.Context, *FindByVerificationCodeUserRequest) (*ApiResponseUser, error) {
...
func _UserQueryService_FindByVerificationCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindByVerificationCodeUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserQueryServiceServer).FindByVerificationCode(ctx, req.(*FindByVerificationCodeUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
