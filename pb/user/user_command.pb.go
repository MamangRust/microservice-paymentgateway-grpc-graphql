...
const file_user_user_command_proto_rawDesc = "" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword2\xc5\x05\n" +
	"\x12UserCommandService\x12>\n" +
	"\x06Create\x12\x1a.pb.user.CreateUserRequest\x1a\x18.pb.user.ApiResponseUser\x12>\n" +
	"\x06Update\x12\x1a.pb.user.UpdateUserRequest\x1a\x18.pb.user.ApiResponseUser\x12R\n" +
	"\x10UpdateIsVerified\x12$.pb.user.UpdateUserIsVerifiedRequest\x1a\x18.pb.user.ApiResponseUser\x12N\n" +
	"\x0eUpdatePassword\x12\".pb.user.UpdateUserPasswordRequest\x1a\x18.pb.user.ApiResponseUser\x12M\n" +
	...
	"\x16DeleteAllUserPermanent\x12\x16.google.protobuf.Empty\x1a\x1b.pb.user.ApiResponseUserAll\"\x00BAZ?github.com/MamangRust/microservice-payment-gateway-grpc/pb/userb\x06proto3"
