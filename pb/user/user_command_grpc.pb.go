...
const (
	...
	UserCommandService_UpdateIsVerified_FullMethodName       = "/pb.user.UserCommandService/UpdateIsVerified"
	UserCommandService_UpdatePassword_FullMethodName         = "/pb.user.UserCommandService/UpdatePassword"
...
func (UnimplementedUserCommandServiceServer) UpdateIsVerified(context.Context, *UpdateUserIsVerifiedRequest) (*ApiResponseUser, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateIsVerified not implemented")
}
...
func (UnimplementedUserCommandServiceServer) TrashedUser(context.Context, *FindByIdUserRequest) (*ApiResponseUserDeleteAt, error) {
	return nil, status.Error(codes.Unimplemented, "method TrashedUser not implemented")
}
...
func (UnimplementedUserCommandServiceServer) DeleteAllUserPermanent(context.Context, *emptypb.Empty) (*ApiResponseUserAll, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteAllUserPermanent not implemented")
}
