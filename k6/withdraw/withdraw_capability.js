...
export default function () {
  ...
  const basicEndpoints = [
    ...
    `/api/stats/withdraw/status/success/monthly?year=2024&month=1`,
    `/api/stats/withdraw/status/success/yearly?year=2024`,
    `/api/stats/withdraw/status/failed/monthly?year=2024&month=1`,
    `/api/stats/withdraw/status/failed/yearly?year=2024`,
    `/api/stats/withdraw/amount/monthly?year=2024`,
    `/api/stats/withdraw/amount/yearly?year=2024`,
  ];
